...
def main(args=sys.argv[1:]):
    ...
    train_data = data_loader.load(data_loader.create_sets("train"), vocab)
    valid_data = data_loader.load(data_loader.create_sets("valid"), vocab)
    test_data = data_loader.load(data_loader.create_sets("test"), vocab)
